...
from src.data_grimorium.general_utils.general_utils import read_file_from_path
...
def test_read_file_from_path(
    ...
    """
    Test the function src/data_grimorium/general_utils/general_utils.read_file_from_path
...
def test_read_file_from_path_exceptions(
    ...
    src/data_grimorium/general_utils/general_utils.read_file_from_path
