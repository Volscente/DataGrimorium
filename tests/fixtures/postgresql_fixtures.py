...
@pytest.fixture
def fixture_postgresql_insert_query(
    query_config=config["postgresql"]["insert_query_config"],
) -> PostgreSQLQueryConfig:
    """
    Fixture for a PostgreSQLQueryConfig object in order to insert values into a table.
...
@pytest.fixture
def fixture_postgresql_select_query(
    query_config=config["postgresql"]["select_query_config"],
) -> PostgreSQLQueryConfig:
    """
    Fixture for a PostgreSQLQueryConfig object in order to select values in a table.
